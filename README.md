...
SSH client on M5Stack Cardputer-Adv with external 2.8" ILI9341 LCD panel (320x240).
...
- LCD's backlignt is controlled by BL-EN signal (3.3V), which is routed to GPIO4. This code controls BL-EN to HIGH.
```
pinMode(4, OUTPUT);
